...
class PagesAssetTests(unittest.TestCase):
    def test_pages_demo_has_share_metadata_and_interactive_script(self) -> None:
        ...
        self.assertIn("recommend the next maintainer workflow", html)
    ...
    def test_attention_workflows_docs_explain_notification_gates(self) -> None:
        ...
        self.assertIn("JackSpiece/maintainer-radar@v0.16.37", docs)
    ...
    def test_social_preview_svg_keeps_source_text(self) -> None:
        ...
        self.assertIn("PR triage that recommends the next workflow", svg)
        self.assertIn("Blocker sweep, review sprint, or follow-up pass.", svg)
